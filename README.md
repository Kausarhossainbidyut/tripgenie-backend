...
- **[Dashboard API](API_DOCUMENTATION.md#dashboard-api)** - Admin analytics and statistics
...
- **Dashboard**: Admin analytics with stats and chart data
...
| **Dashboard** | Stats, Chart Data | Admin |
